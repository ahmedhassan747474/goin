...
class Terms extends Model
{
	...
	public function price_only()
	{
		return $this->hasOne('App\Productmeta','term_id');
	}
	...
	public function addons(){
	  return $this->belongsToMany('App\Terms','addons','term_id','addon_id')->with('price')->select('id','title_en', 'title_ar');
	}
    ...
    {
        return $this->hasMany('App\TermSize','product_id');
    }
