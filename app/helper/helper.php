...
function sendFCM($title_en='', $title_ar='', $message_en='', $message_ar='', $registration_ids='',$image='', $restaurant, $product, $language){
    ...
    $arrayToSend = array('registration_ids' => $registration_ids, 'notification' => $notification, 'data' => $dataArr, 'priority'=>'high');
    ...
    //   $headers = array (
    //     'Authorization: key=' . "AAAAl6NAlqg:APA91bGvdI8FY2CX_OjTjE74t3pgj7YBNeolnhqQOMDYhUZBBYLTVNu4s_aoCVvHucVlP4z58cCJLifCOePDAZAkno1NL3dx0Yd5Ta9QRcZvRz3CvzSQdiIWTTza0Zev3Jc_muT4a3vJ",
    //     'Content-Type: application/json'
    //     );
