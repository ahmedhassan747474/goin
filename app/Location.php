...
class Location extends Model
{
      ...
      {
         return $this->hasOne('App\Terms','auth_id','user_id')->where('type',10)->where('status',1)->select('id','title_en', 'title_ar','auth_id')->wherehas('restaurants')->with('restaurants');
      }
      ...
      {
         return $this->hasOne('App\Terms','id','term_id')->select('id','title_en', 'title_ar','slug');
      }
