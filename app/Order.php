...
class Order extends Model
{
    ...
    {
    	return $this->hasMany('App\Ordermeta')->with('product.preview', 'size', 'addons.addon');
    }

    public function vendorinfo()
    {
    	return $this->hasOne('App\User','id','vendor_id')->with('location','info','avg_ratting', 'preview');
    }
    ...
    {
        return $this->hasOne('App\Terms','id','coupon_id')->select('id','title_en', 'title_ar');
    }
