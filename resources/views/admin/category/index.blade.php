				...
				<form id="basicform" method="post" action="{{ route('admin.category.store') }}">
					...
					<div class="custom-form">
						<div class="form-group">
							...
							<input type="text" name="name" class="form-control" id="name_en" placeholder="Category Name English">
						</div>
						<div class="form-group">
							<label for="name_ar">{{ __('Name') }} (Arabic)</label>
							<input type="text" name="name" class="form-control" id="name_ar" placeholder="Category Name Arabic">
						</div>
						<div class="form-group">
