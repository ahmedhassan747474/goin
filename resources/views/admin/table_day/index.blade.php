		...
		<div class="card-action-filter">
			<div class="row mb-10">
				<div class="card-header">
					<div class="col-lg-10">
					<form id="basicform" method="post" action="{{ route('store.table_day.update', $table_id) }}">
						@csrf
						<div class="d-flex">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $row->day }}</td>
							<td><input type="Time" name="opening[]" class="form-control" required="" value="{{ $row->open }}"></td>
