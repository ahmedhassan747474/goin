...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>['web', 'back_language']],function(){
...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>['web','auth', 'back_language']],function(){
...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers\Admin','middleware'=>['web','auth','admin', 'back_language'],'prefix'=>'admin/', 'as'=>'admin.'],function(){
	...
	Route::get('reservation/date/filter','ReservationController@date_filter')->name('reservation.date.filter');
	Route::get('reservation/{id}','ReservationController@details')->name('reservation.details');
	Route::post('reservationupdate/{id}','ReservationController@update')->name('reservation.update');
	Route::get('reservation/decline/{id}','ReservationController@decline')->name('reservation.decline');
	Route::get('reservation/delete/{id}','ReservationController@delete')->name('reservation.delete');
	Route::post('reservation/city/filter','ReservationController@city')->name('reservation.city');
	Route::get('reservation/type/{type}','ReservationController@type')->name('reservation.type');
	Route::get('reservation_create','ReservationController@create')->name('reservation.create');
	Route::post('reservation_store','ReservationController@store')->name('reservation.store');
});


Route::group(['as' =>'rider.','prefix'=>'rider','namespace'=>'Amcoders\Theme\khana\http\controllers\Rider','middleware'=>['web','auth','rider','verified','riderapproval', 'back_language']],function(){
	// dashboard route
...
Route::group(['as' =>'rider.','prefix'=>'rider','namespace'=>'Amcoders\Theme\khana\http\controllers\Rider','middleware'=>['web', 'back_language']],function(){
	// dashboard route
...
Route::group(['as' =>'author.','prefix'=>'author','namespace'=>'Amcoders\Theme\khana\http\controllers\Author','middleware'=>['web','auth', 'back_language']],function(){
	// dashboard route
	// Route::get('dashboard','DashboardController@dashboard')->name('dashboard');
