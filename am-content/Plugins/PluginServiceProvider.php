	...
	public function boot()
	{
		...
		foreach ($plugins as $plugin) {
			if ($plugin['status'] == 'active') {
				...
				// $this->loadJsonTranslationsFrom(base_path('resources/lang/ar.json'));
				// $this->loadJsonTranslationsFrom(__DIR__.'/ar.json');
				// $this->loadJsonTranslationsFrom(__DIR__ . '/../../../resources/lang');
				// $this->loadJsonTranslationsFrom(__DIR__.'/translations');
				// dump($this->loadRoutesFrom(__DIR__.'/'.$plugin['Text Domain'].'/routes/web.php'));
			}
		}
	}
}