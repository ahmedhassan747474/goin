...
<div class="row">
  <div class="col-sm-4">
    <div class="card">
      <div class="card-title text-center">
        <h5 class="mt-2">{{ __('New Reservations') }}</h5>
      </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-title text-center">
        <h5 class="mt-2">{{ __('Accepted Reservations') }}</h5>
      </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-title text-center">
        <h5 class="mt-2">{{ __('Reservations Completed') }}</h5>
      </div>
...
<script>
  var baseurl= "{{ route('store.reservation.create') }}";
  var mainUrl= "{{ url('/') }}";
