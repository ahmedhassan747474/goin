...
Route::group(['namespace'=>'Amcoders\Plugin\plan\http\controllers','middleware'=>['web','auth','admin', 'back_language'],'prefix'=>'admin/', 'as'=>'admin.'],function(){
...
//'verified',
Route::group(['namespace'=>'Amcoders\Plugin\plan\http\controllers\Store','middleware'=>['web','auth','store','approval', 'back_language'],'prefix'=>'store/', 'as'=>'store.'],function(){
