<?php 
Route::group(['namespace'=>'Amcoders\Plugin\Paymentgetway\http\controllers','middleware'=>['web','auth', 'back_language']],function(){
...
Route::group(['namespace'=>'Amcoders\Plugin\Paymentgetway\http\controllers\subscription','middleware'=>['web','auth','store','verified','approval', 'back_language'],'prefix'=>'store/', 'as'=>'store.'],function(){
