				...
				<form id="basicform" method="post" action="{{ route('admin.shop.category.store') }}">
					...
					<div class="custom-form">
						<div class="form-group">
							...
							<input type="text" name="name_en" class="form-control" id="name_en" placeholder="{{ __('Category Name English') }}">
						</div>
						
						<div class="form-group">
							<label for="name_ar">{{ __('Name') }} ({{ __('Arabic') }})</label>
							<input type="text" name="name_ar" class="form-control" id="name_ar" placeholder="{{ __('Category Name Arabic') }}">
						</div>
