...
Route::group(['as' =>'admin.shop.','prefix'=>'admin/shop','namespace'=>'Amcoders\Plugin\product\http\controllers','middleware'=> ['web','auth','admin', 'back_language']],function(){
...
Route::group(['as' =>'admin.','prefix'=>'admin/','namespace'=>'Amcoders\Plugin\product\http\controllers','middleware'=>['web','auth','admin', 'back_language']],function(){
	...
	Route::post('/products/group','ProductController@group')->name('product.group');
